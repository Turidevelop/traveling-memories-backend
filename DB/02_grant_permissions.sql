...
-- ============================================
-- Permitir que app_user use el esquema
...
GRANT SELECT ON ALL TABLES IN SCHEMA travel TO app_user;
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA travel TO app_user;
...
--   WHERE table_schema = 'travel' AND grantee = 'app_user';
